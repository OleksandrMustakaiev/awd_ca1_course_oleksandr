        ...
        <div class="row justify-content-center pt-4">
          <div class="col-lg-10">
            <form method="get">
              ...
              <div class="form-group">
                <label class="labelHidden" for="date">Course_Code</label>
                <textarea name="description" rows="3" id="course_code" class="form-control" disabled><?= $course->course_code ?></textarea>
              </div>
