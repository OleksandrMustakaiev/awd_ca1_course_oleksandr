          ...
          <div class="col-lg-10">
            <form method="post" action="<?= APP_URL ?>/course-update.php" enctype="multipart/form-data">
              ...
              <label class="labelHidden" for="ticketPrice">Course Code</label>
                <input placeholder="CourseCode" name="course_code" type="text" id="course_code" class="form-control" value="<?= old('course_code', $course->course_code) ?>" />
                <span class="error"><?= error("course_code") ?></span>
              </div>

              <div class="form-group">
              <label class="labelHidden" for="ticketPrice">Cao Points</label>
                <input placeholder="CaoPoints" name="cao_points" type="text" id="cao_points" class="form-control" value="<?= old('cao_points', $course->cao_points) ?>" />
